...
ANCTL_CSSCR = {
    "name": "CSSCR",
    "displayName": "CSSCR",
    "description": "CSS configuration SFR",
    "addressOffset": "0x0B8",
    "size": "0x20",
    "access": "read-write",
    "resetValue": "0x00000000",
...
anctl_define = {
    ...
    "registers": {
        ...
        "register_16": ANCTL_PORCR,
        "register_17": ANCTL_CMPACR,
        "register_18": ANCTL_CMPBCR,
        "register_19": ANCTL_ISR,
        "register_20": ANCTL_IER,
        "register_21": ANCTL_ICR,
        "register_22": ANCTL_CMPASR,
        "register_23": ANCTL_CMPBSR,
        "register_24": ANCTL_CSSENR,
        "register_25": ANCTL_CSSCR,
    }
}