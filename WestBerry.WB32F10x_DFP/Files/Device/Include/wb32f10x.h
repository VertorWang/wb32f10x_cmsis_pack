...
#ifndef __WB32F10x_H__
#define __WB32F10x_H__
...
/**
 * @brief WB32F10x Standard Peripheral Library version number
 */
#define __WB32F10x_STDPERIPH_VERSION_MAIN   (0x00) /*!< [31:24] main version */
#define __WB32F10x_STDPERIPH_VERSION_SUB1   (0x01) /*!< [23:16] sub1 version */
#define __WB32F10x_STDPERIPH_VERSION_SUB2   (0x0A) /*!< [15:8]  sub2 version */
#define __WB32F10x_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __WB32F10x_STDPERIPH_VERSION        ( (__WB32F10x_STDPERIPH_VERSION_MAIN << 24)\
                                             |(__WB32F10x_STDPERIPH_VERSION_SUB1 << 16)\
                                             |(__WB32F10x_STDPERIPH_VERSION_SUB2 << 8)\
                                             |(__WB32F10x_STDPERIPH_VERSION_RC))

/**
  * @}
  */

#define MHSI_VALUE    (8000000)       /*!< Value of the Internal 8M oscillator in Hz*/
#define FHSI_VALUE    (48000000)      /*!< Value of the Internal 48M oscillator in Hz*/
...
#define __MPU_PRESENT             1         /* WB32F10x devices provide an MPU */
#define __VTOR_PRESENT            1         /* VTOR present or not */
#define __NVIC_PRIO_BITS          4         /* Number of Bits used for Priority Levels */
#define __Vendor_SysTickConfig    0         /* Set to 1 if different SysTick Config is used */

#include "core_cm3.h"                       /* Processor and core peripherals */
#include "system_wb32f10x.h"                /* System Header */
